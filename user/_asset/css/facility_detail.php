...
<?php
    $announcement_array = $db_handler->runQuery("SELECT announcement_submit,announcement_detail FROM announcement;");
...
<div class="f_img">
    ...
    <button class="book_btn" onclick="window.location.href='book_court.php?FID=<?php echo $f_id?>'">Book Now</button>
    <br>
