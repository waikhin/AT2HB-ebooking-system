            ...
            <div class="row">
              <div class="col-12">
                <div class="card card-secondary">
                  ...
                  <!-- /.card-header -->
<?php 
    $paid_array = $db_handler->runQuery("SELECT invoice_id,user_id,user_name,invoice_pay_amount,court_name,reservation_date
    FROM invoice JOIN (reservation JOIN user USING(user_id)  JOIN court USING(court_id))USING(reservation_id)
                    ...
                    <table class="table table-head-fixed table-hover text-nowrap">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>Bacon ipsum dolor sit amet salami venison chicken flank fatback doner.</td>
                          <td><button type="button" class="btn" onclick="alert('hi')" ><i class="fas fa-search-plus "></i></button></td>
                          <td><button type="button" class="btn btn-success btn-sm" onclick="" style='width:2.5em'><i class="fas fa-check"></i></button>&nbsp &nbsp &nbsp<button type="button" class="btn btn-danger btn-sm" onclick="" style='width:2.5em'><i class="fas fa-times"></i></button></td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
...
?>
                        <tr>
                          <td><?php echo $paid_array[$key]["invoice_id"]; ?></td>
                          <td><?php echo $paid_array[$key]["reservation_date"]; ?></td>
                          <td><?php echo $paid_array[$key]["user_id"]; ?></td>
                          <td><?php echo $paid_array[$key]["user_name"]; ?></td>
                          <td><?php echo $paid_array[$key]["court_name"]; ?></td>
                          <td><?php echo number_format($paid_array[$key]["invoice_pay_amount"],2); ?></td>
                          <td><button type="button" class="btn" onclick="alert('hi')" ><i class="fas fa-search-plus "></i></button></td>
                          <td><button type="button" class="btn btn-primary btn-sm" onclick="" style='width:2.5em'><i class="fas fa-print"></i></td>
                        </tr>
<?php }} ?>
                        <tr>
                          <td>183</td>
                          ...
                          <td>10.00</td>
                          <td><button type="button" class="btn" onclick="alert('hi')" ><i class="fas fa-search-plus "></i></button></td>
                          <td><button type="button" class="btn btn-primary btn-sm" onclick="" style='width:2.5em'><i class="fas fa-print"></i></button></td>
                        </tr>
                        </tbody>
                    </table>
                  </div>
                    ...
                    <thead>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>Basketball Court 1</td>
                          <td>0123456789</td>
                          <td>davio@mail.com</td>
                          <td><button type="button" class="btn" onclick="alert('hi')" ><i class="fas fa-search-plus "></i></button></td>
                          <td><button type="button" class="btn btn-primary btn-sm" onclick="" style='width:2.5em'><i class="fas fa-print"></i></button>&nbsp &nbsp &nbsp<button type="button" class="btn btn-danger btn-sm" onclick="" style='width:2.5em'><i class="fas fa-envelope"></i></button></td>
                        </tr>
                        <tr>
                        <td>183</td>
                          <td>11/11/2021</td>
...
<!-- invoice -->
<script src="_asset/js/invoice_crud.js"></script>
</body>
</html>
